...
class Seq2seq(nn.Module):
    ...
    def forward(self, input_variable, input_lengths=None, target_variable=None, target_lengths=None,
                teacher_forcing_ratio=0):
        encoder_outputs, encoder_hidden, encoder_context = self.encoder(input_variable, input_lengths)
        result = self.decoder(inputs=target_variable,
                              inputs_lengths=target_lengths,
